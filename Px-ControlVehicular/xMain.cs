...
using Px_ControlVehicular.Catalogos;
using Px_ControlVehicular.Properties;
using Px_ControlVehicular.Utiles.Theme;
using Px_ControlVehicular.Utiles.Generales;
using Px_ControlVehicular.Catalogos.Controles;

using static Px_ControlVehicular.Utiles.Emun.Enumerados;
...
namespace Px_ControlVehicular
{
    public partial class xMain : Form
    {
        ...
        private async Task InicioForma()
        {
            ...
            this.Text = "GBC | Control vehicular";
