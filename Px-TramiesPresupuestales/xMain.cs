...
using Px_TramiesPresupuestales.Catalogos;
using Px_TramiesPresupuestales.Properties;
using Px_TramiesPresupuestales.Utiles.Theme;
using Px_TramiesPresupuestales.Utiles.Generales;
using Px_TramiesPresupuestales.Catalogos.Controles;

using static Px_TramiesPresupuestales.Utiles.Emun.Enumerados;
...
namespace Px_TramiesPresupuestales
{
    public partial class xMain : Form
    {
        ...
        private async Task InicioForma()
        {
            ...
            this.Text = "GBC | Tramites presupuestales";
