...
using Px_PadronIdentidad.Catalogos;
using Px_PadronIdentidad.Properties;
using Px_PadronIdentidad.Utiles.Theme;
using Px_PadronIdentidad.Utiles.Generales;
using Px_PadronIdentidad.Catalogos.Controles;

using static Px_PadronIdentidad.Utiles.Emun.Enumerados;
...
namespace Px_PadronIdentidad
{
    public partial class xMain : Form
    {
        ...
        private async Task InicioForma()
        {
            ...
            this.Text = "GBC | Padron de identidad";
