...
using Px_ImpuestosEstatales.Catalogos;
using Px_ImpuestosEstatales.Properties;
using Px_ImpuestosEstatales.Utiles.Theme;
using Px_ImpuestosEstatales.Utiles.Generales;
using Px_ImpuestosEstatales.Catalogos.Controles;

using static Px_ImpuestosEstatales.Utiles.Emun.Enumerados;
...
namespace Px_ImpuestosEstatales
{
    public partial class xMain : Form
    {
        ...
        private async Task InicioForma()
        {
            ...
            this.Text = "GBC | Impuestos estatales";
