...
using Px_Ingresos.Catalogos;
using Px_Ingresos.Properties;
using Px_Ingresos.Utiles.Theme;
using Px_Ingresos.Utiles.Generales;
using Px_Ingresos.Catalogos.Controles;

using static Px_Ingresos.Utiles.Emun.Enumerados;
