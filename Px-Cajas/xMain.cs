...
using Px_Cajas.Catalogos;
using Px_Cajas.Properties;
using Px_Cajas.Utiles.Theme;
using Px_Cajas.Utiles.Generales;
using Px_Cajas.Catalogos.Controles;

using static Px_Cajas.Utiles.Emun.Enumerados;
