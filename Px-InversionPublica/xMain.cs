...
using Px_InversionPublica.Catalogos;
using Px_InversionPublica.Properties;
using Px_InversionPublica.Utiles.Theme;
using Px_InversionPublica.Utiles.Generales;
using Px_InversionPublica.Catalogos.Controles;
...
namespace Px_InversionPublica
{
    public partial class xMain : Form
    {
        ...
        private async Task InicioForma()
        {
            ...
            this.Text = "GBC | Invresión pública";
