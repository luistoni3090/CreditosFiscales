...
namespace Px_Controles.Controls.DataGridView
{
    ...
    [ToolboxItem(false)]
    public partial class UIDataGridViewTreeRow : UserControl, IDataGridViewRow
    {
        #region 属性
        /// <summary>
        /// CheckBox选中事件
        ...
        public int RowLevel
        {
            ...
            set
            {
                ...
                this.uiSplitLine_V1.Visible = value > 0;
            }
        }
        ...
        private List<UIDataGridViewTreeRow> childrenRows = new List<UIDataGridViewTreeRow>();

        public List<UIDataGridViewTreeRow> ChildrenRows
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UIDataGridViewTreeRow" /> class.
        /// </summary>
        public UIDataGridViewTreeRow()
        {
            InitializeComponent();
        }
        ...
        {
            IsChecked = ((UICheckBox)sender).Checked;
        }
                ...
                if (!IsOpened.Value)
                {
                    ...
                    else
                    {
                        ...
                        if (proChildrens != null)
                        {
                            ...
                            {
                                UIDataGridViewTreeRow row = new UIDataGridViewTreeRow();
                                if (value is DataTable)
                                {
        ...
        private void HideChildrenRows(UIDataGridViewTreeRow row)
        {
