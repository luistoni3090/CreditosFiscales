...
namespace Px_Controles.Forms.Msg
{
    ...
    public partial class MessageBoxMX : FrmBase
    {
            ...
            )
        {
            ...
            {
                var frm = new MessageBoxMX(BGColor, strMessage, strTitle, iTipo, blnShowCancel, blnShowClose, blnIsEnterClose)
                {
