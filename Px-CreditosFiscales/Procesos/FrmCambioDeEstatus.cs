...
namespace Px_CreditosFiscales
{
    public partial class FrmCambioDeEstatus : FormaGenBar
    {
        ...
        private async Task LoadMainGrid1()
        {
            ...
            dataGridView1.Columns.Add("Tipo de Pago", "Tipo de Pago");
            dataGridView1.Columns.Add("Importe", "Importe");

            panelGrid1.Controls.Add(dataGridView1);

        }

        private async Task LoadMainGrid2()
        {
            ...
            panelGrid2.Controls.Add(dataGridView1);
        }
