...
namespace Px_CreditosFiscales
{
    public partial class FrmPagosManual : FormaGenBar
    {
        ...
        {
            MessageBoxMX.ShowDialog(null, $"No existen recibos en el ingreso con esa fecha ", "Aviso", (int)StatusColorsTypes.Warning, false);
        }
    }
}
