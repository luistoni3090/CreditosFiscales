...
{
    public partial class FrmStatusbien : Form
    {
        public xMain _Main { get; set; }

        eRequest oReq = new eRequest();
        DataGridView oGrid = new DataGridView();
        List<eSTATUS_BIEN> _Con = new List<eSTATUS_BIEN>();
        List<eSTATUS_BIEN> _ConFiltra = new List<eSTATUS_BIEN>();
        eSTATUS_BIEN _Reg3 = new eSTATUS_BIEN();

        #region Contructor
        public FrmStatusbien()
        {
            InitializeComponent();
        ...
        private async Task Inicio()
        {
            ...
            lblTitulo.Text = "Catálogo del Status del Bien";
        ...
        private async Task conActualiza()
        {
            ...
            TimeSpan ts = DateTime.Now - startTime;
            if (_Main != null)
                await _Main.Status($"Catálogo del Status del Bien. Tiempo: {ts}", (int)MensajeTipo.Success);
        ...
        private async Task conActualizaDBGrid1()
        {
            ...
            try
            {
                ...
                if (!Object.ReferenceEquals(null, oRes.Data.Tables[0]))
                    _Con = oRes.Data.Tables[0].AListaDe<eSTATUS_BIEN>();
        ...
        private async Task<bool> conValidaSiExisteRegistro(string ANIO, string MES)
        {
            ...
            try
            {
                ...
                if (oRes.Data.Tables.Count > 0 && oRes.Data.Tables[0].Rows.Count > 0){ 
                    if (!Object.ReferenceEquals(null, oRes.Data.Tables[0]))
                        _Reg3 = oRes.Data.Tables[0].Rows[0].RowAObjetoDe<eSTATUS_BIEN>();
                    existe = true;
                }
