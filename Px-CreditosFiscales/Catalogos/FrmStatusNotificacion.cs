...
{
    public partial class FrmStatusNotificacion : Form
    {
        public xMain _Main { get; set; }

        eRequest oReq = new eRequest();
        DataGridView oGrid = new DataGridView();
        List<eSTATUS_NOTIFICACION> _Con = new List<eSTATUS_NOTIFICACION>();
        List<eSTATUS_NOTIFICACION> _ConFiltra = new List<eSTATUS_NOTIFICACION>();
        eSTATUS_NOTIFICACION _Reg3 = new eSTATUS_NOTIFICACION();

        #region Contructor
        public FrmStatusNotificacion()
        {
            InitializeComponent();
        ...
        private async Task Inicio()
        {
            ...
            lblTitulo.Text = "Catálogo de Status de Notificación";
        ...
        private async Task Grid1()
        {
            ...
            {
                new DataGridViewTextBoxColumn() { HeaderText = "Status ", Width = 200,  DataPropertyName = "STATUS" },
        ...
        private async Task conActualiza()
        {
            ...
            TimeSpan ts = DateTime.Now - startTime;
            if (_Main != null)
                await _Main.Status($"Catálogo de Status de Notificación . Tiempo: {ts}", (int)MensajeTipo.Success);
        ...
        private async Task conActualizaDBGrid1()
        {
            ...
            try
            {
                ...
                if (!Object.ReferenceEquals(null, oRes.Data.Tables[0]))
                    _Con = oRes.Data.Tables[0].AListaDe<eSTATUS_NOTIFICACION>();
        ...
        private async Task<bool> conValidaSiExisteRegistro(string ANIO, string MES)
        {
            ...
            try
            {
                ...
                if (oRes.Data.Tables.Count > 0 && oRes.Data.Tables[0].Rows.Count > 0){ 
                    if (!Object.ReferenceEquals(null, oRes.Data.Tables[0]))
                        _Reg3 = oRes.Data.Tables[0].Rows[0].RowAObjetoDe<eSTATUS_NOTIFICACION>();
                    existe = true;
                }
