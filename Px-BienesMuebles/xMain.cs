...
using Px_BienesMuebles.Catalogos;
using Px_BienesMuebles.Properties;
using Px_BienesMuebles.Utiles.Theme;
using Px_BienesMuebles.Utiles.Generales;
using Px_BienesMuebles.Catalogos.Controles;

using static Px_BienesMuebles.Utiles.Emun.Enumerados;


namespace Px_BienesMuebles
{
