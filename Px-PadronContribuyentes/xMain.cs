...
using Px_PadronContribuyentes.Catalogos;
using Px_PadronContribuyentes.Properties;
using Px_PadronContribuyentes.Utiles.Theme;
using Px_PadronContribuyentes.Utiles.Generales;
using Px_PadronContribuyentes.Catalogos.Controles;

using static Px_PadronContribuyentes.Utiles.Emun.Enumerados;
...
namespace Px_PadronContribuyentes
{
    public partial class xMain : Form
    {
        ...
        private async Task InicioForma()
        {
            ...
            this.Text = "GBC | Padrón de identidad";
