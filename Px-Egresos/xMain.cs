...
using Px_Egresos.Catalogos;
using Px_Egresos.Properties;
using Px_Egresos.Utiles.Theme;
using Px_Egresos.Utiles.Generales;
using Px_Egresos.Catalogos.Controles;

using static Px_Egresos.Utiles.Emun.Enumerados;
