...
using Px_CajasServicioPublico.Catalogos;
using Px_CajasServicioPublico.Properties;
using Px_CajasServicioPublico.Utiles.Theme;
...
namespace Px_CajasServicioPublico
{
    public partial class xMain : Form
    {
        ...
        private async Task InicioForma()
        {
            ...
            this.Text = "GBC | Cajas servicio público";
